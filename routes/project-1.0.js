        ...
        router.post('/delete', async (req, res) => {
          ...
          try{
            ...
            const serialNumber = {};
              ...
              if(!exists){
              throw new Error ('ERROR serialNumber NOT FOUND at "/delete"')
              } else {

                const query = await Dbschema.findOneAndDelete(serialNumber);          
                res.status(200).end();
            ...
            console.error(`Error handling POST request at '/delete' : => ${Error}`);
            res.status(400).json({message: Error.message});
          }
        ...
        try{
          ...
          const serialNumber = {};
            ...
            throw new Error ('ERROR serialNumber NOT FOUND')
              ...
              payload.lastUpdateFromBms = query[0].inputVS.updated.slice(-1)[0];
              console.log(query[0].inputVS.updated.slice(-1)[0]);
